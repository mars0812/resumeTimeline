...
**2013.05 - 至今 [`银联随行`](https://itunes.apple.com/cn/app/yin-lian-sui-xing/id433602054?mt=8&ls=1)**
...
**2013.05 - 2013.06 [`justDoIT`](https://itunes.apple.com/us/app/justdoit-jiu-shita/id644928674?ls=1&mt=8)**
    ...
    项目业绩:
            完成整个作品
    项目描述:
            个人业余作品,已在`App Store`上架;点击上面连接进入下载页面.
...
**2012.12 - 2013.05 [`StellaSDK`](http://en.morningtec.cn/stella)**
    ...
    所在公司:
            yeecco
    项目职责:
            开发StellaKit中的NavigationController和NavigationBar
            移植GCD中的libdispatch
            移植GNUStep的libobjc2
    项目业绩:
